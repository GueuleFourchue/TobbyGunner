...
namespace Paladin.Framework.Utilities
{
    public static class PlayerPrefsUtility
    {
        ...
        {
            bool userConfirmed = EditorUtility.DisplayDialog("Think about this for a minute.",
                "Are you sure you want to clear all of your PlayerPrefs data? "
                + "You will lose progress in your current game.",
                "Yes.", "I'm scared, I just want to go home.");
